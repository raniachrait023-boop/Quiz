...
public class computer2 extends AppCompatActivity {
    int quiz;
...
retour.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent i1 = new Intent(computer2.this,computer1.class);
        ...
        suivant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(computer2.this,computer3.class);
