...
public class resultat_science extends AppCompatActivity {
    int quiz;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resultat_science);
        ...
        merci.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(resultat_science.this,MainActivity.class);
                startActivity(i);
            }
        });
