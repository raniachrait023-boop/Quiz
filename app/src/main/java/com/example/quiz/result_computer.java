...
public class result_computer extends AppCompatActivity {
    int quiz;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_computer);
        ...
        merci.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(result_computer.this,MainActivity.class);
                startActivity(i);
            }
        });
    }
